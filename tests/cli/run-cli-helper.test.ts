...
// Windows refuses to delete a directory that is some process's working
// directory, so the "cwd was removed underneath us" state cannot be built.
test.skipIf(process.platform === "win32")(
  "a throw during setup clears the guard instead of wedging the process",
  async () => {
