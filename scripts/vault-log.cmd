@echo off
rem Append one event to the vault log.
rem Windows twin of the bash launcher beside it (scripts/vault-log); cmd.exe
...
"%O2B_BUN%" run "%O2B_ROOT%\src\cli\main.ts" append-event %*
exit /b %ERRORLEVEL%
