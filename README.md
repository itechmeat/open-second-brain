...
```mermaid
flowchart LR
    Vault[("Your vault<br/>Brain/ + AI Wiki/ + Daily/")]
...
|---|---|---|
| 1 | Plain Markdown in your Obsidian vault | `Brain/preferences/pref-*.md`, `Brain/log/<date>.md`, `AI Wiki/`, `Daily/` - real files you open in Obsidian. Wikilinks, backlinks, and the graph view work out of the box. |
