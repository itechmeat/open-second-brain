...
Full list of verbs across `o2b`, `o2b brain`, `o2b vault`, and `o2b discipline` in [`docs/cli-reference.md`](docs/cli-reference.md).
...
- Text written through Brain redaction strips `<private>...</private>` regions before storage and masks secret-shaped assignments such as `api_key=...`.
