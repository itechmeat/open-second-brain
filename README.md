...
**Native Windows** (10/11, x64) is supported alongside Linux and macOS: Bun from `install.ps1`, `.cmd` launchers instead of symlinks, config under `%LOCALAPPDATA%` - [`install/windows.md`](install/windows.md).
