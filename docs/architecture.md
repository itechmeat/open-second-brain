...
is the point rather than its size. One hundred and one classified tools carry 231 call
...
stops the closed run from passing vacuously. The other 199 carry a claim of
