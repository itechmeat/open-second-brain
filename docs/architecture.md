...
is the point rather than its size. One hundred and one classified tools carry 230 call
...
stops the closed run from passing vacuously. The other 198 carry a claim of
