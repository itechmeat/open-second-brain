...
is the point rather than its size. Ninety-eight classified tools carry 224 call
...
stops the closed run from passing vacuously. The other 192 carry a claim of
