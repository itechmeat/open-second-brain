...
- **Trade-offs**:
  ...
  - Pro: keeps OSB's conflict-free per-event-file + replayable-fold convention; no SQLite hot-path writes; determinism and O(candidates) preserved via in-memory edge/activation maps over the candidate set.
