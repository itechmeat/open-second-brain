  ...
  },
  {
    ...
    keys: [
      ...
      def("tool_profile", INSTALL_TOOL_PROFILE_DEFAULT, [
        ...
        `selects (${INSTALL_TOOL_PROFILE_NAMES.join(", ")}). The default`,
        "advertises every tool, which is what generated content selected",
        "before this key existed. An unknown name is refused here, not",
        "failed open: generating a registration for a profile that does",
        "not exist installs a surface nobody named.",
      ]),
    ],
  },
  {
